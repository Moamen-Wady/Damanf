...
export default function Ula() {
    ...
    return (
        <ul className='aul1 '>
            ...
            <li className='al '><Link to='/arServices#mm' className='all '><p>الخدمات</p></Link></li>
            <li className='al '><Link to='/arAboutus#mm' className='all '><p>اعرف عنا</p></Link></li>
            <li className='ar '><Link to='/arContactus#container' className='all ' id="rdr"><p>تواصل معنا</p></Link></li>
        </ul>
    )
}
